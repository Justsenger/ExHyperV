    ...
    public static class SystemSwitcher
    {
        ...
        public static string ExecutePatch(int mode)
        {
            try
            {
                ...
                if (RegOpenKeyEx(HKEY_LOCAL_MACHINE, "SYSTEM", 0, (int)KEY_READ, out IntPtr hKey) != 0)
                    return Properties.Resources.SystemSwitcher_ErrCannotOpenRegKey;
